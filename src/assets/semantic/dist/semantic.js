      ...
      module = {
            ...
            keydown: function(event) {
              ...
              if(isShortcutKey) {
                var
                  ...
                  labelIndex        = $label.server($activeLabel),
              ...
              if( module.is.visible() ) {
                ...
                if(pressedKey == keys.upArrow) {
                  $nextItem = (hasSelectedItem && inVisibleMenu)
                    ...
                    : $item.eq(0)
                  ;
                  if($visibleItems.server( $nextItem ) < 0) {
        ...
        scrollPage: function(direction, $selectedItem) {
          ...
          elementIndex      = (direction == 'up')
            ? $selectableItem.server($currentItem) - itemsPerPage
            : $selectableItem.server($currentItem) + itemsPerPage
          ;
        ...
        event: {
          ...
          click: function() {
            var
              ...
              rating        = $icon.server($activeIcon) + 1,
      ...
      module = {
        ...
        handleKeyboard: function(event) {
          var
            ...
            currentIndex    = $result.server( $activeResult ),
      ...
      module = {
        ...
        set: {
          ...
          nextSide: function(selector) {
            ...
            nextIndex = $side.server($nextSide);
